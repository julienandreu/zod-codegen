...
// Latest edit: Sat, 06 Jan 2024 21:42:28 GMT
...
export class SwaggerPetstoreOpenAPI30 {
  ...
  ): Promise<AxiosResponse<z.infer<typeof Pet>>> {
  ...
  async getPetById(
    ...
    const response = await this.#makeApiRequest('get', compile('/pet/{petId}')({
      petId
    }), {}, {});
    const safeResponseData = Pet.parse(response.data);
    return {
  ...
  async updatePetWithForm(
    ...
    const response = await this.#makeApiRequest('post', compile('/pet/{petId}')({
      petId
    }), { name, status }, {});
    return response;
  }
  async deletePet(
    petId: z.infer<typeof PathParameterPetId>,
    api_key?: z.infer<typeof HeaderParameterApi_key>,
  ) {
    const response = await this.#makeApiRequest('delete', compile('/pet/{petId}')({
      petId
    }), {}, { api_key });
    return response;
  }
  async uploadFile(
    ...
    const response = await this.#makeApiRequest('post', compile('/pet/{petId}/uploadImage')({
      petId
    }), { additionalMetadata }, {});
  ...
  async getInventory(
  ): Promise<AxiosResponse<z.infer<typeof GetInventoryResponse>>> {
  ...
  ): Promise<AxiosResponse<z.infer<typeof Order>>> {
  ...
  async getOrderById(
    orderId: z.infer<typeof PathParameterOrderId>,
  ): Promise<AxiosResponse<z.infer<typeof Order>>> {
    const response = await this.#makeApiRequest('get', compile('/store/order/{orderId}')({
      orderId
    }), {}, {});
    const safeResponseData = Order.parse(response.data);
    return {
  ...
  async deleteOrder(
    ...
    const response = await this.#makeApiRequest('delete', compile('/store/order/{orderId}')({
      orderId
    }), {}, {});
    return response;
  }
  ...
  ): Promise<AxiosResponse<z.infer<typeof User>>> {
  ...
  async getUserByName(
    username: z.infer<typeof PathParameterUsername>,
  ): Promise<AxiosResponse<z.infer<typeof User>>> {
    const response = await this.#makeApiRequest('get', compile('/user/{username}')({
      username
    }), {}, {});
    const safeResponseData = User.parse(response.data);
    return {
  ...
  async updateUser(
    ...
    const safeData = User.parse(user);
    const response = await this.#makeApiRequest('put', compile('/user/{username}')({
      username
    }), {}, {}, safeData);
    return response;
  }
  async deleteUser(
    ...
    const response = await this.#makeApiRequest('delete', compile('/user/{username}')({
      username
    }), {}, {});
    return response;
  }
